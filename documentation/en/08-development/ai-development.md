...
3. For `lib/` tasks use the prompt in `.agents/prompts/lib-prompt.md`.
4. For `core/` tasks use the prompt in `.agents/prompts/core-prompt.md`.
5. For MCP, provider and CI ideas read `.agents/guides/mcp-integration.md`.
5. After changes run:
   ```bash
