...
source "${RUNNER_DIR}/testframework.sh"
...
main() {
  print_header "BS Framework Comprehensive Test Suite / Комплексный набор тестов фреймворка BS"
  ...
  echo -e "${BLUE}Tests run / Тестов запущено:${NC} $total_tests"
